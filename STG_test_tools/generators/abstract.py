...
# TODO: В C библиотеке для каждого метода реализованы специальные процедуры для расчета истории пульсаций в
#  заданной точке предварительно сгенерированной сетки, а также расчета поля скоростей на всей сетке на
#  заданном шаге по времени. Для обоих процедур предварительно должен происходить расчет динамических
#  вспомогательных данных и сохранение в памяти программы всей истории расчета. Расчет этих данных нужно
#  осуществить только на текущем шаге по времени и внедрить в процедуры расчета истории пульсаций в точке и
#  мгновенного поля скоростей. Расчет истории вспомогательных данных оставить только для метода SEM в виде отдельной
#  процедуры. Для него она нужна для тестирования движения вихрей.
